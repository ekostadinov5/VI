...
class Kutii(Problem):
    ...
    def goal_test(self, state):
        covece, (K1, K2, K3) = state
        return K1 in tocki and K2 in tocki and K3 in tocki
    ...
    def successor(self, state):
        ...
        #Gore
        newCovece = (X - 1, Y)
        if newCovece not in kutii and X > 0: #GoreC
                successors["GoreC"] = (newCovece, kutii)
        else: #GoreCK
            if newCovece == K1 and K1 not in tocki and XK1 > 0 and (XK1 - 1, YK1) not in kutii:
                successors["GoreCK"] = (newCovece, ((XK1 - 1, YK1), K2, K3))
            if newCovece == K2 and K2 not in tocki and XK2 > 0 and (XK2 - 1, YK2) not in kutii:
                successors["GoreCK"] = (newCovece, (K1, (XK2 - 1, YK2), K3))
            if newCovece == K3 and K3 not in tocki and XK3 > 0 and (XK3 - 1, YK3) not in kutii:
                successors["GoreCK"] = (newCovece, (K1, K2, (XK3 - 1, YK3)))

        #Dolu
        newCovece = (X + 1, Y)
        if newCovece not in kutii and X < 7:  # DoluC
            successors["DoluC"] = (newCovece, kutii)
        else:  # DoluCK
            if newCovece == K1 and K1 not in tocki and XK1 < 7 and (XK1 + 1, YK1) not in kutii:
                successors["DoluCK"] = (newCovece, ((XK1 + 1, YK1), K2, K3))
            if newCovece == K2 and K2 not in tocki and XK2 < 7 and (XK2 + 1, YK2) not in kutii:
                successors["DoluCK"] = (newCovece, (K1, (XK2 + 1, YK2), K3))
            if newCovece == K3 and K3 not in tocki and XK3 < 7 and (XK3 + 1, YK3) not in kutii:
                successors["DoluCK"] = (newCovece, (K1, K2, (XK3 + 1, YK3)))

        #Levo
        newCovece = (X, Y - 1)
        if newCovece not in kutii and Y > 0:  # LevoC
            successors["LevoC"] = (newCovece, kutii)
        else:  # LevoCK
            if newCovece == K1 and K1 not in tocki and YK1 > 0 and (XK1, YK1 - 1) not in kutii:
                successors["LevoCK"] = (newCovece, ((XK1, YK1 - 1), K2, K3))
            if newCovece == K2 and K2 not in tocki and YK2 > 0 and (XK2, YK2 - 1) not in kutii:
                successors["LevoCK"] = (newCovece, (K1, (XK2, YK2 - 1), K3))
            if newCovece == K3 and K3 not in tocki and YK3 > 0 and (XK3, YK3 - 1) not in kutii:
                successors["LevoCK"] = (newCovece, (K1, K2, (XK3, YK3 - 1)))

        #Desno
        newCovece = (X, Y + 1)
        if newCovece not in kutii and Y < 9:  # DesnoC
            successors["DesnoC"] = (newCovece, kutii)
        else:  # DesnoCK
            if newCovece == K1 and K1 not in tocki and YK1 < 9 and (XK1, YK1 + 1) not in kutii:
                successors["DesnoCK"] = (newCovece, ((XK1, YK1 + 1), K2, K3))
            if newCovece == K2 and K2 not in tocki and YK2 < 9 and (XK2, YK2 + 1) not in kutii:
                successors["DesnoCK"] = (newCovece, (K1, (XK2, YK2 + 1), K3))
            if newCovece == K3 and K3 not in tocki and YK3 < 9 and (XK3, YK3 + 1) not in kutii:
                successors["DesnoCK"] = (newCovece, (K1, K2, (XK3, YK3 + 1)))
...
if __name__ == '__main__':
    ...
    instanca = Kutii(((man_row, man_column), ((b1_row, b1_column), (b2_row, b2_column), (b3_row, b3_column))))
