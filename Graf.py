...
ABdistance = distance(locs["A"], locs["B"])
BIdistance = distance(locs["B"], locs["I"])
BCdistance = distance(locs["B"], locs["C"])
HIdistance = distance(locs["H"], locs["I"])
IJdistance = distance(locs["I"], locs["J"])
FCdistance = distance(locs["F"], locs["C"])
GCdistance = distance(locs["G"], locs["C"])
CDdistance = distance(locs["C"], locs["D"])
FGdistance = distance(locs["F"], locs["G"])
FJdistance = distance(locs["F"], locs["J"])
KGdistance = distance(locs["K"], locs["G"])
LKdistance = distance(locs["L"], locs["K"])
DEdistance = distance(locs["D"], locs["E"])
DLdistance = distance(locs["D"], locs["L"])
LMdistance = distance(locs["L"], locs["M"])
...
instanca11 = GraphProblem(Pocetok, Stanica1, graph)
instanca12 = GraphProblem(Stanica1, Kraj, graph)

instanca21 = GraphProblem(Pocetok, Stanica2, graph)
instanca22 = GraphProblem(Stanica2, Kraj, graph)

resenie11 = astar_search(instanca11)
resenie12 = astar_search(instanca12)

resenie21 = astar_search(instanca21)
resenie22 = astar_search(instanca22)

resenie1 = resenie11.solve() + resenie12.solution()
resenie2 = resenie21.solve() + resenie22.solution()

cena1 = resenie11.path_cost + resenie12.path_cost
cena2 = resenie21.path_cost + resenie22.path_cost
